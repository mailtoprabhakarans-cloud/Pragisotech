...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pragiso Soft Technologies | Innovate • Build • Grow" },
      {
        name: "description",
        content:
          "Pragiso Soft Technologies builds modern websites, mobile apps, digital marketing and UI/UX design solutions.",
      },
